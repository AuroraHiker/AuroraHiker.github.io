...
笔者参照GROMACS官方对运行环境的要求，整理了一份硬件配置速查表，并附上了自己的配置，供大家参考。需要说明的是，这份配置目前仅为理论推测，欢迎各位读者结合实际使用情况提供反馈。

**GROMACS的硬件配置速查表:**

| 部件 | 最低要求 | 推荐配置(入门) | 推荐配置(进阶) | 笔者的配置 |
|------|-----------|--------------|-------------|-------------|
...
关于系统环境的选择，在这篇博客中进行了对比和详细介绍：{% post_link 如何搭建合适的生信实验平台 %}
