...
打开[西农er's GPT](https://gpt.nwafu-ai.cn/)，使用教育邮箱注册并完成验证 ( [点此跳转官方使用指南](https://blog.nwafu-ai.cn/archives/1705731294486) )。截至本文最新更新，Codex 分组享有较大折扣。若需使用 gpt-5.5 等最新 OpenAI 模型，请新建令牌时选择 Codex 分组，其费率仅为 0.18 元/美元。

登录后从右上角的用户头像点击‘个人资料’或‘钱包’进入个人主页，点击‘API密钥’，创建一个新令牌，选择分组为`codex`：
...
若因网络问题导致安装失败，可下载[离线版 Codex 安装包](https://fenjueai.com/pages/codex-offline.html)进行手动安装，该方式可有效规避网络异常带来的影响。
