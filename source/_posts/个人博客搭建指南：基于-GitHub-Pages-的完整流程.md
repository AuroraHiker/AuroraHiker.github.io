...
```
详细的、其他系统的安装说明见[Hexo官网](https://hexo.io/zh-cn/docs/) (也涵盖其他操作系统)。如果你已经安装过 Hexo，可以直接跳过本节。需要提醒的是，若后续准备换用 Fluid 主题，请提前确认 Hexo 版本不低于 5.0.0，Node.js 版本不低于 10.13.0。
...
至于博客外观和交互细节，笔者打算持续更新 **Fluid 主题的完整配置**——从外观美化、评论系统接入，到响应式优化，都会一步步写清楚。感兴趣的话，记得来看。
